...
var _login = require('./components/login.js/login.js');
...
(0, _jquery2.default)(".app-login.js form").on("submit", function (e) {
  e.preventDefault();

  (0, _jquery2.default)(".app-login.js .app-container").addClass("__loading");

  clearTimeout(timeout);
  timeout = setTimeout(function () {
    (0, _jquery2.default)(".app-login.js .app-container").removeClass("__loading");
  }, 3000);
});
